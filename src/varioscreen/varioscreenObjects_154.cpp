...
const unsigned char zerotageOff[] PROGMEM = {
	  //zeroingoffx32, 32x32px
	
};

const unsigned char zerotageOn [] PROGMEM = {
      //zeroingonx32, 32x32px
	
};
...
//	display.drawRect(posX, posY, 32, 32, GxEPD_BLACK);
  if (_mute || (volume == 0))  display.drawInvertedBitmap(posX, posY, volume0icons, 32, 32, GxEPD_BLACK);   //GxEPD_BLACK);
   ...
   //ajout d'un indicateur de zerotage sonore à gauche
  display.fillRect(posX -30, posY , 32, 32, GxEPD_WHITE);
  if (beeper.isWithZerotage()){
		display.drawInvertedBitmap(posX -30, posY , zerotageOn, 32, 32, GxEPD_BLACK); 
  } else {
		display.drawInvertedBitmap(posX -30, posY , zerotageOff, 32, 32, GxEPD_BLACK); 
  }
