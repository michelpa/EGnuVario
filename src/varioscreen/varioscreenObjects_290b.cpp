 ...
 *    1.1.11 19/02/20   Ajout variolog                                           *
 *    1.1.12 21/02/20   Correction bug affichage batterie   					 *	
 *    1.1.13 04/03/20   Réorganisation de l'affichage des variable               *
 *    1.1.14 05/03/20   Ajout affichage AGL                                      *
 *    1.1.15 06/03/20   Ajout gestion icone DISPLAY_OBJECT_TREND                 *
 *    1.1.16 09/03/20   Modification de l'effacement digit left                  *
