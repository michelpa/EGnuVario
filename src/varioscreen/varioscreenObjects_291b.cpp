...
//		titleY = anchorY - MaxHeight - 5; 		
 ...
 /*  Affiche titre */
  ...
  if (showtitle) {
		...
		display.setTextSize(1);
		display.setCursor(titleX, titleY+1); 
...
const unsigned char zerotageOff[] PROGMEM = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
	0xff, 0xff, 0xff, 0xc3, 0xff, 0xff, 0x00, 0xbf, 0xfe, 0x00, 0x3f, 0xfe, 0x18, 0x1f, 0xfc, 0x30, 
	0x3f, 0xfc, 0x40, 0x3f, 0xfc, 0x02, 0x3f, 0xfc, 0x0c, 0x3f, 0xf8, 0x18, 0x7f, 0xfc, 0x00, 0x7f, 
	0xfd, 0x00, 0xff, 0xff, 0xc3, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
};

const unsigned char zerotageOn [] PROGMEM = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
	0xff, 0xff, 0xff, 0xc3, 0xff, 0xff, 0x00, 0xff, 0xfe, 0x00, 0x7f, 0xfe, 0x18, 0x7f, 0xfc, 0x3c, 
	0x3f, 0xfc, 0x7e, 0x3f, 0xfc, 0x7e, 0x3f, 0xfc, 0x3c, 0x3f, 0xfe, 0x18, 0x7f, 0xfe, 0x00, 0x7f, 
	0xff, 0x00, 0xff, 0xff, 0xc3, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
};
...
//	display.drawRect(posX, posY, 32, 32, GxEPD_BLACK);
  ...
  display.fillRect(posX, posY + 19, 24, 24, GxEPD_WHITE);
  if (beeper.isWithZerotage()){
		display.drawInvertedBitmap(posX, posY + 19 , zerotageOn, 24, 24, GxEPD_BLACK); 
  } else {
		display.drawInvertedBitmap(posX, posY + 19 , zerotageOff, 24, 24, GxEPD_BLACK); 
  }
}
